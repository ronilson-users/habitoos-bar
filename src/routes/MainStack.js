...
import { View, Text, S1tyleSheet } from "react-native";
...
export default function MainStack() {
    return (
        ...
        >
            <Drawer.Screen name="Abrir Mesa" component={AbrirMesa} />
            <Drawer.Screen name="Criar Mesa" component={CriarMesa} />
            ...
            <Drawer.Screen name="MyDraggable" component={MyDraggable} />
        </Drawer.Navigator>
    );
}
